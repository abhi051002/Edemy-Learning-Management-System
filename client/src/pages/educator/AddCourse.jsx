        ...
        <div>
          ...
          {showPopup && (
            <div className="fixed inset-0 bg-black/20 backdrop-blur-xs flex items-center justify-center z-50">
              <div className="bg-white text-gray-700 p-6 rounded-lg relative w-full max-w-md mx-4 shadow-xl border border-white/20">
                ...
                <div className="mb-4">
                  <p className="mb-1">Lecture Duration (minutes)</p>
                  <input
                    type="number"
                    className="w-full border border-gray-300 rounded py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
